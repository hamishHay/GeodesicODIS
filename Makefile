...
FFLAGS= -c -I/home/hamish/Research/SHTOOLS/modules -m64 -fPIC -O3 -ffast-math -L/home/hamish/Research/SHTOOLS/lib -lSHTOOLS -L/usr/local/lib -lfftw3 -lm -llapack -lblas
