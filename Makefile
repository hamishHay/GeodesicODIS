...
# FRAMEWORK 
CFLAGS = -O1 -Wall -Iinclude -Wno-sign-compare -I$(CONSTS_DIR) -Wunused-but-set-variable -msse4 -std=c++17 -I/usr/local/ -I/usr/include/hdf5/serial -march=native #-lhdf5 -lhdf5_cpp -Ofast -ffast-math 
