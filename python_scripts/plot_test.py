...
for i in range(nn, nn+1):
    ...
    # vel_lon = in_file["face longitude"][:]
    ...
    c2 = ax2.tricontourf(triang,data_eta,21)
    c3 = ax3.tricontourf(triang,data_eta,21)#levels=levels)
    ax3.quiver(triang.x, triang.y, data_u, data_v, scale=300.0)
