...
int updateVelocity2Layer(Globals *, Mesh *, Array2D<double> &, Array2D<double> &, Array1D<double> &, Array1D<double> &, Array1D<double> &, double, int);
int updateDisplacement(Globals *, Mesh *, Array1D<double> &, Array2D<double> &);
int updateDisplacement(Globals *, Mesh *, Array1D<double> &, Array1D<double> &, Array1D<double> &, Array2D<double> &);
